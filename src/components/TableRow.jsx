...
const TableRow = ({ row, level = 0 }) => {
  ...
  const borderClass =
    level === 0 ? "border-b-2 border-gray-300" : "border-b border-gray-200";

  return (
    <>
      <tr
        className={`${rowBgClass} ${borderClass} hover:bg-gray-100 transition-colors duration-200`}
      >
        <td
          className={`px-8 py-6 border-r border-gray-200 text-center ${indentClass}`}
        >
